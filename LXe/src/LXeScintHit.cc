...
LXeScintHit::LXeScintHit() : fEdep(0.), fPos(0.), fPhysVol(0), fparticle(0), fTime1(0) {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

LXeScintHit::LXeScintHit(G4VPhysicalVolume* pVol, G4ParticleDefinition* pPart, G4double time1) : fPhysVol(pVol), fparticle(pPart), fTime1(time1) {}
